let pokemons = [
  ...
  },
  {
    ...
    "num": "089",
    "name": "Muk",
    "img": "s://www.serebii.net/pokemongo/pokemon/089.png",
    "type": [
      "Poison"
    ],
    "height": "1.19 m",
...
const elMovieList = document.querySelector(".pokemon__list");
...
for (let i = 0; i < pokemons.length; i++) {
  ...
  newName.textContent = element.weaknesses;
...
// newLi.setAttribute("class", "card");
// newLi.style.width = "18rem";
// console.log(newImg.setAttribute("src", pokemons.img));
...
//   newLi.style.width = "18rem";
//   newImg.classList.add("card-img-top");
//   newImg.setAttribute("src", pokemons.img);
//   newDiv.classList.add("card-body");
//   newTitle.classList.add("card-title");
//   newLanguage.classList.add("card-text");
//   newYear.classList.add("card-text");

//   newTitle.textContent = pokemons.title;
